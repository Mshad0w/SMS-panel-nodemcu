...
const uint8_t fingerprint[20] = {0xF5, 0x3D, 0xC8, 0xCC, 0xF1, 0xEE, 0x53, 0xB7, 0xE6, 0x79, 0xA5, 0x6C, 0x77, 0xFA, 0xD7, 0x78, 0x0E, 0x35, 0x75, 0x44};
